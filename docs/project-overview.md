...
```
jesse-mlops-project        <- Root directory. Both monorepo and polyrepo are supported.
│
├── jesse_mlops_project       <- Contains python code, notebooks and ML resources related to one ML project. 
│   │
