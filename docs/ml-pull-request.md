...
Opening a pull request will trigger a[workflow](../.github/workflows/jesse-mlops-project-run-tests-fs.yml) 
...
* [Staging workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/staging-jesse-mlops-project-model)
* [Prod workspace registered model](https://adb-984752964297111.11.azuredatabricks.net#mlflow/models/prod-jesse-mlops-project-model)
