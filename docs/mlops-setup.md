...
[ML Config](../jesse_mlops_project/resources/README.md)  guides to make changes to ML code or deployed jobs.
...
```
git add README.md docs .gitignore jesse_mlops_project/resources/README.md
...
Follow the instructions in [jesse-mlops-project/resources/README.md](../jesse_mlops_project/resources/README.md) to deploy ML resources
and production jobs.
...
[ML pull request guide](ml-pull-request.md) and [ML resource config guide](../jesse_mlops_project/resources/README.md)  to propose, test, and deploy
